...
MODULE seq_infodata_mod
  ...
  type seq_infodata_type
     ...
     logical                 :: flux_simple     ! T => Simple atm/ocn fluxes
     integer(SHR_KIND_IN)    :: flux_simple_opt ! 1 => Frierson atm/ocn fluxes
...
CONTAINS
  ...
  SUBROUTINE seq_infodata_Init( infodata, nmlfile, ID, pioid, cpl_tag)
    ...
    if (seq_comm_iamroot(ID)) then
       ...
       infodata%flux_simple           = flux_simple
       infodata%flux_simple_opt       = flux_simple_opt
  ...
  SUBROUTINE seq_infodata_GetData_explicit( infodata, cime_model, case_name, case_desc, timing_dir,  &
    ...
    logical,                optional, intent(OUT) :: flux_simple             ! T => Simple atm/ocn fluxes
    integer(SHR_KIND_IN),   optional, intent(OUT) :: flux_simple_opt         ! 1 => Frierson atm/ocn fluxes
    ...
    if ( present(flux_simple)    ) flux_simple    = infodata%flux_simple
    if ( present(flux_simple_opt)) flux_simple_opt= infodata%flux_simple_opt
  ...
  SUBROUTINE seq_infodata_PutData_explicit( infodata, cime_model, case_name, case_desc, timing_dir,  &
    ...
    logical,                optional, intent(IN)    :: flux_simple             ! T => Simple atm/ocn fluxes
    integer(SHR_KIND_IN),   optional, intent(IN)    :: flux_simple_opt         ! 1 => Frierson atm/ocn fluxes
    ...
    if ( present(flux_simple)    ) infodata%flux_simple    = flux_simple
    if ( present(flux_simple_opt)) infodata%flux_simple_opt= flux_simple_opt
  ...
  subroutine seq_infodata_bcast(infodata,mpicom)
    ...
    call shr_mpi_bcast(infodata%flux_simple,             mpicom)
    call shr_mpi_bcast(infodata%flux_simple_opt,         mpicom)
  ...
  SUBROUTINE seq_infodata_print( infodata )
    ...
    write(logunit,F0L) subname,'flux_simple              = ', infodata%flux_simple
    write(logunit,F0L) subname,'flux_simple_opt          = ', infodata%flux_simple_opt
